 ...
 */
public class MyBobyAdapter extends RecyclerView.Adapter<MyBobyAdapter.MyViewHolder> {
    private Context context;
    private List<Data.DataBean.TagBean> list;
    private MyViewHolder holder;

    public MyBobyAdapter(Context context,List<Data.DataBean.TagBean> list) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        holder = new MyViewHolder(LayoutInflater.from(
                context ).inflate(R.layout.my_boby_item, parent,
                false));
        return holder;
    }
